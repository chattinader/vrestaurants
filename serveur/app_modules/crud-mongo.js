...
exports.createRestaurant = function(formData, callback) {
  MongoClient.connect(url, function(err, client) {
    ...
    if(!err) {
      ...
      toInsert.name = formData.nom;
      toInsert.cuisine = formData.cuisine;
      toInsert.grades.grade = formData.grades.grade;
      toInsert.address.building = formData.address.building;
      toInsert.address.street = formData.address.street;
      toInsert.address.zipcode = formData.address.zipcode;
      toInsert.borough = formData.borough;
...
exports.updateRestaurant = function(id, formData, callback) {
  ...
  MongoClient.connect(url, function(err, client) {
    ...
    if(!err) {
      ...
      newvalues.name = formData.nom;
      newvalues.cuisine = formData.cuisine;
      newvalues.grades.grade = formData.grades.grade;
      newvalues.address.building = formData.address.building;
      newvalues.address.street = formData.address.street;
      newvalues.address.zipcode = formData.address.zipcode;
      newvalues.borough = formData.borough;
